...
if($group_id_of_acc_logged >= $config['site']['access_admin_panel'])
{
	...
	switch($action)
	{
		case 'list':
			...
			$result .= '<p><a href="?subtopic=shopadmin">Shop admin</a> | <a href="?subtopic=shopadmin&action=new">Novo</a> | <a href="?subtopic=shopadmin&action=list">Listar</a></p>';
		...
		case 'edit':
			$main_content .= '<p><a href="?subtopic=shopadmin">Shop admin</a> | <a href="?subtopic=shopadmin&action=new">Novo</a> | <a href="?subtopic=shopadmin&action=list">Listar</a></p>';
			...
			{
				$dropdown = '<select name="offer_type"><option value="mounts" selected="selected">mounts</option><option value="mounts">mounts</option></select>';
			}
                        else if($dados['offer_type'] == 'addons')
			{
				$dropdown = '<select name="offer_type"><option value="addons" selected="selected">addons</option></select>';
			}
		...
		case 'new':
			...
			$main_content .= <<<EOD
				...
				<form method="post" action="?subtopic=shopadmin&action=shop_save">
					...
					<p class="border"><strong>Tipo da oferta</strong></p>
					<p><label class="admshop">Tipo: </label><select name="offer_type"><option value="item" selected="selected">Item</option><option value="mounts">Mounts</option><option value="addons">Addons</option></select></p>
